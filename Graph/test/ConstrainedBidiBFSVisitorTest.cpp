...
{
	ConstrainedBidiBFSVisitor<Graph> visitor(0, 3, 1, 0, 2);
...
{
	ConstrainedBidiBFSVisitor<Graph> visitor(0, 0, 1, 0, 0);
...
{
	ConstrainedBidiBFSVisitor<Graph> visitor(0, 1, 1, 0, 1);
...
{
	ConstrainedBidiBFSVisitor<Graph> visitor(0, 3, 2, 0, 2);
	bidirectionalBFS(simpleCyclicGraph, 0, 3, visitor);
