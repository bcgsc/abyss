...
ALL_DIRS = $(COMMON_DIR) $(DATALAYER_DIR) $(ABYSS_DIR) $(PROOFREAD_DIR) $(PARTITION_DIR) $(TRIMMER_DIR) $(REMOVE_MULTIPLICITY_DIR) $(TEST_DIR) $(PARALLEL_DIR) $(ALIGN_DIR)
...
ALIGN_SRC = $(wildcard $(ALIGN_DIR)/*.cpp)

ALL_SRC = $(COMMON_SRC) $(DATALAYER_SRC) $(ABYSS_SRC) $(PROOFREAD_SRC) $(PARTITION_SRC) $(TRIMMER_SRC) $(REMOVE_MULTIPLICITY_SRC) $(PARALLEL_SRC) $(SCAFFOLD_SRC) $(ALIGN_SRC)
...
ALIGN_OBJ = $(patsubst %.cpp,%.o,$(ALIGN_SRC))

ALL_OBJECTS = $(COMMON_OBJ) $(DATALAYER_OBJ) $(ABYSS_OBJ) $(PROOFREAD_OBJ) $(PARTITION_OBJ) $(TRIMMER_OBJ) $(ESTIMATE_CONTIG_OBJ) $(VALIDATE_OBJ) $(REMOVE_MULTIPLICITY_OBJ) $(PARALLEL_OBJ) $(SCAFFOLD_OBJ) $(ALIGN_OBJ)
...
SCAFFOLD_OBJECTS = $(COMMON_OBJ) $(DATALAYER_OBJ) $(SCAFFOLD_OBJ) $(ALIGN_OBJ)
...
Common/CommonUtils.o: Common/CommonUtils.h Common/Sequence.h
...
Common/SeqExt.o: Common/Prb.h Common/CommonUtils.h Common/Sequence.h
...
Parallel/NetworkSequenceCollection.o: Common/Sequence.h Common/CommonDefs.h
Parallel/NetworkSequenceCollection.o: Common/ReadPrb.h Common/Prb.h
Parallel/NetworkSequenceCollection.o: Common/SeqExt.h
