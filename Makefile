...
ALL_DIRS = $(COMMON_DIR) $(DATALAYER_DIR) $(ABYSS_DIR) $(PROOFREAD_DIR) $(PARTITION_DIR) $(TRIMMER_DIR) $(REMOVE_MULTIPLICITY_DIR) $(TEST_DIR)
...
ALL_SRC = $(COMMON_SRC) $(DATALAYER_SRC) $(ABYSS_SRC) $(PROOFREAD_SRC) $(PARTITION_SRC) $(TRIMMER_SRC) $(REMOVE_MULTIPLICITY_SRC)
...
ALL_OBJECTS = $(COMMON_OBJ) $(DATALAYER_OBJ) $(ABYSS_OBJ) $(PROOFREAD_OBJ) $(PARTITION_OBJ) $(TRIMMER_OBJ) $(ESTIMATE_CONTIG_OBJ) $(VALIDATE_OBJ) $(REMOVE_MULTIPLICITY_OBJ)
...
all:
	$(MAKE) ABYSS ProofReader Partition Trimmer RemoveMultiplicity test
...
ABYSS/Abyss.o: /usr/lib/gcc/i386-redhat-linux/3.4.6/include/stddef.h
...
ABYSS/Abyss.o: /usr/lib/gcc/i386-redhat-linux/3.4.6/include/stdarg.h
...
ABYSS/Abyss.o: Common/ReadPrb.h Common/Prb.h /usr/include/assert.h
ABYSS/Abyss.o: DataLayer/Reader.h Common/PhaseSpace.h Common/PackedSeq.h
...
ABYSS/Abyss.o: DataLayer/PackedSeqWriter.h
ABYSS/Path.o: ABYSS/Path.h Common/CommonDefs.h Common/ReadPrb.h Common/Prb.h
ABYSS/Path.o: /usr/include/assert.h /usr/include/features.h
ABYSS/Path.o: /usr/include/sys/cdefs.h /usr/include/gnu/stubs.h
ABYSS/Path.o: Common/SeqRecord.h Common/PackedSeq.h Common/Sequence.h
ABYSS/Path.o: Common/CommonUtils.h
ABYSS/PathDriver.o: ABYSS/PathDriver.h Common/CommonDefs.h Common/ReadPrb.h
ABYSS/PathDriver.o: Common/Prb.h /usr/include/assert.h
ABYSS/PathDriver.o: /usr/include/features.h /usr/include/sys/cdefs.h
ABYSS/PathDriver.o: /usr/include/gnu/stubs.h ABYSS/Path.h Common/SeqRecord.h
ABYSS/PathDriver.o: Common/PackedSeq.h Common/Sequence.h Common/HitRecord.h
ABYSS/PathDriver.o: Common/PhaseSpace.h /usr/include/stdio.h
ABYSS/PathDriver.o: /usr/lib/gcc/i386-redhat-linux/3.4.6/include/stddef.h
ABYSS/PathDriver.o: /usr/include/bits/types.h /usr/include/bits/wordsize.h
...
ABYSS/PathDriver.o: /usr/lib/gcc/i386-redhat-linux/3.4.6/include/stdarg.h
