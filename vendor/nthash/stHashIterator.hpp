...
public:
    ...
    */
    ...
    void snp(const std::vector<unsigned>& positions, const std::vector<unsigned char>& newBases, const unsigned m) {
        snpHash(m_fhVal, m_rhVal, m_seq.c_str() + m_pos, positions, newBases, m_k, m, m_hVec);
    }
